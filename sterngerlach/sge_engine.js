...
SGE.CAMERA_Z_NEAR				=	0.001; // camera frustum z-near distance
SGE.CAMERA_Z_FAR				=	10; // camera frustum z-far distance
...
SGE.focus_point       = new THREE.Vector3(0,0,0);
...
// -------------------------------------------------------------------------------------------------
// Colors
SGE.DEFAULT_BACKGROUND_COLOR	=	0xFFFFFF; // dark blue
SGE.SKY_COLOR					=	0x707070; // base color for the sky sphere (dark teal)
...
SGE.GLOW_COLOR					=	0x7F7F7F;
SGE.NORTH_COLOR					=	0x3F3F3F;
SGE.SOUTH_COLOR					=	0xBFBFBF;
SGE.MAGNETIC_FIELD_COLOR		=	0x7F7F7F;
...
SGE.ANGLE_METER_COLOR			=	0xBFBFBF;
...
SGE.LOOP_PRECESSION_FREQUENCY	=	.5;
...
SGE.AXES_COLOR_X				=	0x7F7F7F;
SGE.AXES_COLOR_Y				=	0x7F7F7F;
SGE.AXES_COLOR_Z				=	0x7F7F7F;
...
SGE.Viewport3D = function(w, h, bgcolor) { SGE.Component.call(this); // initialized parent class
	...
	this.render = function() {
		if (!stop) {this.updatePointerOvers();
	...
	this.blink = function() {
		...
		TweenMax.to(
			o, 0, {
				glow: 1,
				onComplete: function() {
					TweenMax.to(o, 0, { glow: 0, delay: 0.2 });
				}
			}
		);
	}
